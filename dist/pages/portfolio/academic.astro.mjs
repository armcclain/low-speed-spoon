...
const $$Academic = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$BaseLayout, { "title": "Academic \u2014 the low-speed spoon", "theme": "theme-portfolio" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="mx-auto max-w-6xl px-4 py-16"> <h1 class="text-xl font-medium mb-6">academic</h1> <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6"> ${renderComponent($$result2, "ProjectCard", $$ProjectCard, { "title": "academic sample", "blurb": "a placeholder for research visuals.", "href": "#", "meta": "data viz" })} </div> </section> ` })}`;
